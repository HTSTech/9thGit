...
var e,
    ...
    return (
      <div id='HeaderID'>
        <body id="igsx"><div data-gjs="navbar" className="navbar"><div className="navbar-container"><Link href="/" className="navbar-brand"></Link><div id="ir56" className="navbar-burger"><div className="navbar-burger-line"></div><div className="navbar-burger-line"></div><div className="navbar-burger-line"></div></div><div data-gjs="navbar-items" className="navbar-items-c"><nav data-gjs="navbar-menu" className="navbar-menu"><Link href="Footer" className="navbar-menu-link">Home</Link><Link href="About" className="navbar-menu-link">About</Link></nav></div></div></div></body>
        <style>
